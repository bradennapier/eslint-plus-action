...
function getLintAnnotation(annotation, data) {
    return `- ${getAnnotationFileLink(annotation, data)} ${getAnnotationFileLine(annotation)} - ${annotation.message}${data.issueSummaryType === 'full' ? getAnnotationSuggestions(annotation) : ''}`;
}
